	...
	return (
		<div className="contactUs">
			...
			<div className="contactUs__text">
				<div>
					<h2 className="contactUs__heading">Address</h2>
					<br></br>
					...
					<br></br>
					<br></br>
					<ul className="contactUs__icons">
						<li>
							<a
								className="contactUs__icon contactUs__icon--yt"
						...
						<li>
							<a
								className="contactUs__icon contactUs__icon--insta"
						...
						<li>
							<a
								className="contactUs__icon contactUs__icon--linkedin"
